...
<div class="row">
    <div class="col-sm-12">
        <h4 class="page-title">Article Details: {{ $article->title }}</h4> 
    </div>
</div>
@endsection
            ...
            <div class="widget author-widget clearfix">
                ...
                <div class="about-author">
                    <div class="about-author-img">
                        <div class="author-img-wrap"> <img class="img-fluid rounded-circle" alt="" src="{{ asset('back_auth/assets/profile/'.$article->author->picture) }}"> </div>
                    </div>
